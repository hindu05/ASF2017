...
<!--modal boks-->
	<aside id="modal">
		...
		<article>
			<h2>Vi sender live</h2>
			<p>Følg med når vi sender live fra vores 'Eat to the Beat' event i aften, hvor vi også vil introducere vores helt ny drinks bar Dash!</p>
		</article>
		<img src="img/logolive.png">
	</aside>
<!-- væl sprog-->
	<div id="language">
		<p><a href="../da/index">da </a><span>|</span><a href="../en/index"> en</a></p>
	</div>
...
<!-- Køkkener og sorteringsmekanisme-->
...
<section id="køkkener" class="kitchen col-md-offset-1 col-md-10 col-lg-offset-1 col-lg-10">
	<div id="sortingarea">
		...
		<select id="sorting">
			<option value="1">Hvad kan man få?</option>
	...
	<div class="kitchenitem drikke col-md-4 col-lg-3 col-sm-6">
		...
		<h3>Dash</h3>
		<p>Hos os kan alle drikke cocktails</p>
		</a>
	</div>
	<div class="kitchenitem mad col-md-4 col-lg-3 col-sm-6">
	...
	<div class="kitchenitem mad col-md-4 col-lg-3 col-sm-6">
		<a href="kitchens/lapastafresca" title="La pasta fresca" target="_self"><img alt="kitchen profile image" src="img/kitchens/lapastafresca.jpg">
		<h3>La Pasta Fresca</h3>
		<p>Frisklavet pasta</p>
		</a>
	</div>
...
<script>
	//smooth scrolling til køkkensectionen
...
>>>>>>> 2da017a664a04fbda76f7296f330ee1dd7469d45
